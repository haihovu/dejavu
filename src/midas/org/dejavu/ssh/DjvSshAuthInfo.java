...
public class DjvSshAuthInfo
{
	 ...
	 */
	private final Map<String, String> m_CmdPrompts = new HashMap<>(16);
	 ...
	 */
	public DjvSshAuthInfo(String server, String userName, String password)
	{
		m_UserName = userName;
		m_Password = password;
		m_ServerAddr = server;
	 ...
	 * @return This object.
	 */
	public DjvSshAuthInfo setCmdlinePrompt(String dir, String prompt)
	{
		synchronized(m_CmdPrompts)
		{
	 ...
	 * @return This object.
	 */
	public synchronized DjvSshAuthInfo setUserName(String userName)
	{
	 ...
	 * @return This object.
	 */
	public synchronized DjvSshAuthInfo setPassword(String password)
	{
