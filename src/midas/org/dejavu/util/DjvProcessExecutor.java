 ...
 * @author haiv
 */
public class DjvProcessExecutor
{
	/**
	 ...
	 */
	private DjvProcessMonitor procMon;
	 ...
	 */
	public DjvProcessExecutor(String name, String... cmds)
	{
		this.name = name;
		this.cmds = cmds;
	}
	 ...
	 */
	private DjvProcessMonitor getProcMon()
	{
		synchronized(this)
		{
			return procMon;
	...
	{
		DjvProcessMonitor mon = getProcMon();
		if (mon != null)
		{
	 ...
	 * @throws IOException
	 */
	private DjvProcessMonitor initiateProcess(String name, String cmdline, boolean monitorStderr) throws IOException
	{
		...
		DjvBackgroundTask mon = new DjvProcessMonitor(name, proc, monitorStderr).start();
		return (DjvProcessMonitor)mon;
	}
}