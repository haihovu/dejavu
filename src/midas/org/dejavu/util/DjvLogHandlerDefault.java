...
public class DjvLogHandlerDefault implements DjvLogHandler, Runnable
{
	...
	{
		m_LogQueue = new LinkedBlockingQueue<DjvLogMsg>(queueSize);
	}
	...
	public void run()
	{
		try
		{
			while(isRunFlag())
			{
				DjvLogMsg log = m_LogQueue.poll(2, TimeUnit.SECONDS);
				if(log == null)
					continue;
	...
	private final LinkedBlockingQueue<DjvLogMsg> m_LogQueue;
