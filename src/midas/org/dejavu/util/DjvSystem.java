 ...
 * A default implementation is provided by MiDAS, {@link DjvSystemDefault},
 it is recommended that application extend DjvSystemDefault instead of DjvSystem directly.
 */
public abstract class DjvSystem
{
	...
	/**
	 * Registers a concrete implementation of the DjvLogHandler class.
	 * Only one instance of DjvLogHandler may be registered. Log requests
 are forwarded to the registered handler.
	...
	public static DjvLogHandler getLogHandler()
	{
		synchronized(s_LogLock)
		{
			if(null == s_LogHandler)
			{
				...
				s_LogHandler = new DjvLogHandler()
				{
	...
	/**
	 * Registers a concrete implementation of the DjvSystem class.
	 ...
	 */
	private static volatile DjvLogHandler s_LogHandler;
	/**
