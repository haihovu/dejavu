 ...
 * @author haiv
 */
public abstract class MiBackgroundTask implements Runnable
{
	 ...
	 */
	public MiBackgroundTask(String taskName)
	{
	 ...
	 * @return This object.
	 */
	public MiBackgroundTask setRunFlag(boolean value)
	{
		runFlag = value;
		return this;
	}
