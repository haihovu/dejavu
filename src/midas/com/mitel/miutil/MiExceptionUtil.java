...
public class MiExceptionUtil
{
	...
	/**
	 * Creates a standard simple warning message about an exception, with a compact stack trace using the default trace depth.
	 * For use with logging.
	 * @param ex The exception to be processed.
	 * @return The warning string about the given exception, typically something like this:
	 * "Encountered <i>exception string</i> at <i>compact trace</i>".
	 */
	...
	/**
	 * Creates a standard simple warning message about an exception, with a compact trace.
	 * For use with logging.
	 * @param ex The exception to be processed.
	...
	/**
	 * Returns a compressed, human-readable trace representation of the given throwable,
	 * for logging purposes.
	 * @param theThrowable The target throwable.
	 * @return The compressed representation of the trace of the given throwable.
	 */
	...
	/**
	 * Returns a compressed, human-readable representation stack trace of the current thread,
	 * for logging purposes.
	...
	/**
	 * Returns a compressed, human-readable representation of the given stack trace,
	 * for logging purposes.
