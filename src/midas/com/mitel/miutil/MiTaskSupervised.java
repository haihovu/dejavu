 ...
 * @author haiv
 */
public abstract class MiTaskSupervised implements Runnable
{
	/**
	 ...
	 */
	public MiTaskSupervised(String name)
	{
		taskName = name;
	}
	 ...
	 * @return This object.
	 */
	public MiTaskSupervised addListener(Listener listener)
	{
	 ...
	 * @return This object.
	 */
	public MiTaskSupervised removeListener(Listener listener)
	{
		synchronized(listeners)
		{
	 ...
	 */
	public boolean start(MiTaskManager taskManager, long timeoutMs) throws InterruptedException
	{
