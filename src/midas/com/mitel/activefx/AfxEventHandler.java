...
/**
 * The interface for handling Active FX events. 
 * Typically used by Active FX clients to get request notifications.
 */
public interface AfxEventHandler
{
	/**
	 * The Active FX connection had been open, and is ready for read/write request.
	 */
	void openCompleted();
	...
	/**
	 * The previous read request is now completed, 
	 * the supplied buffer is filled with data read in from the network.
	 * @param returnedBuffer The buffer given to the read command, which now contains the input data.
	 */
