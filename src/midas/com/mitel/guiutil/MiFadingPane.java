 ...
 * @author haiv
 */
public abstract class MiFadingPane extends JPanel{
	 ...
	 * is supported.
	 */
	private class TaskDismissInititate extends MiBackgroundTask {
		/**
			...
			try {
				...
				if(delayMs > 0) {
					try {
						...
						synchronized(MiFadingPane.this) {
							fading = true;
						}
	...
	private MiBackgroundTask taskFadeProcessor;
	/**
	 ...
	 */
	protected MiFadingPane(ActionListener disposalListener) {
		super();
	 ...
	 * @return This object
	 */
	protected MiFadingPane setCleared(boolean value) {
		synchronized(this) {
			cleared = value;
		}
		return this;
