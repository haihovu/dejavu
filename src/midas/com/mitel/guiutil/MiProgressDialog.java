 ...
 * @author  Hai Vu
 */
public class MiProgressDialog extends JDialog
{
	 ...
	 */
	private MiProgressDialog(Frame parent, Component anchor, String title, int initialValue, boolean indetermninate, MiProgressListener listener)
	{
		super(parent, true);
	 ...
	 * @param listener The optional listener for events such as cancel.
	 */
	private MiProgressDialog(Dialog parent, Component anchor, String title, int initialValue, boolean indetermninate, MiProgressListener listener)
	{
		super(parent, true);
		m_AnchorComponent = anchor;
		m_Indeterminate = indetermninate;
	 ...
	 * @param listener The optional listener for events such as cancel.
	 */
	private MiProgressDialog(Window parent, Component anchor, String title, int initialValue, boolean indetermninate, MiProgressListener listener)
	{
	 ...
	 * @param listener The optional listener for events such as cancel.
	 */
	private MiProgressDialog(Component anchor, String title, int initialValue, boolean indetermninate, MiProgressListener listener)
	{
	...
	/**
	 * Instantiates a new instance of MiProgressDialog, outside of AWT event dispatch thread.
	 * @param anchor The anchor for this dialog.
	 * @param title The tile of the dialog
	 * @param initialValue The initial progress value (typically zero)
	 * @param listener The optional listener for events such as cancel.
	 * @return A new instance of MiProgressDialog, or null if one cannot be instantiated.
	 */
	public static MiProgressDialog safeInstantiate(Component anchor, String title, int initialValue, MiProgressListener listener)
	{
	 ...
	 * @return A new instance of MiProgressDialog, or null if one cannot be instantiated.
	 */
	public static MiProgressDialog safeInstantiate(Component parent, String title, int initialValue, boolean indeterminate, MiProgressListener listener)
	{
		if(SwingUtilities.isEventDispatchThread())
		{
			if(parent instanceof Frame)
			{
				return new MiProgressDialog((Frame)parent, parent, title, initialValue, indeterminate, listener);
			}
			else if(parent instanceof Dialog)
			{
				return new MiProgressDialog((Dialog)parent, parent, title, initialValue, indeterminate, listener);
			}
			else if(parent instanceof Window)
			{
				return new MiProgressDialog((Window)parent, parent, title, initialValue, indeterminate, listener);
			}
			return new MiProgressDialog(parent, title, initialValue, indeterminate, listener);
		}
    ...
    private void initComponents() {
        ...
        progressDialogOk.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("com/mitel/guiutil/GeneralGui").getString("cancelLabel"), new Object[] {})); // NOI18N
	...
	public static void main(String args[])
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			...
			public void run()
			{
				...
				MiProgressDialog dialog = MiProgressDialog.safeInstantiate(testFrame, "Test", 12, new MiProgressListener()
				{
					@Override
	 ...
	 * @return This object.
	 */
	public MiProgressDialog setOptionalText(java.lang.String text)
	{
	 ...
	 * @return This object.
	 */
	public MiProgressDialog setCancelButtonText(String newText)
	{
	 ...
	 * @return This object.
	 */
	public MiProgressDialog setProgress(int percent)
	{
	 ...
	 * @return This object.
	 */
	public MiProgressDialog setProgress(String text)
	{
	 ...
	 * @return This dialog.
	 */
	public MiProgressDialog start()
	{
		MiGuiUtil.centerAndMakeVisible(this, m_AnchorComponent);
		return this;
	}
	...
	public void dismiss()
	{
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				MiProgressDialog.this.setVisible(false);
				MiProgressDialog.this.dispose();
			}
		});
	}
	 ...
	 */
	class BgTaskDismiss extends MiBackgroundTask
	{
	 ...
	 * @return This object.
	 */
	public MiProgressDialog setDimension(Dimension newDimension)
	{
	...
	private static class SwingTaskStaticInstantiator implements Runnable
	{
		...
		private MiProgressDialog returnValue;
		...
		private MiProgressDialog waitForReturn(long timeoutMs) throws InterruptedException
		{
		...
		public void run()
		{
			try
			{
				synchronized(returnLock)
				{
					...
					{
						returnValue = new MiProgressDialog((Frame)parentComponent, parentComponent, dialogTitle, initialPercent, indeterminateFlag, clientListener);
					}
					else if(parentComponent instanceof Dialog)
					{
						returnValue = new MiProgressDialog((Dialog)parentComponent, parentComponent, dialogTitle, initialPercent, indeterminateFlag, clientListener);
					}
					else if(parentComponent instanceof Window)
					{
						returnValue = new MiProgressDialog((Window)parentComponent, parentComponent, dialogTitle, initialPercent, indeterminateFlag, clientListener);
					}
					else
					{
						returnValue = new MiProgressDialog(parentComponent, dialogTitle, initialPercent, indeterminateFlag, clientListener);
					}
