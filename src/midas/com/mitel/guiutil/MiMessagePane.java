 ...
 * as glass panes.
 */
public class MiMessagePane extends MiFadingPane {
	 ...
	 * once from the EDT.
	 */
	public MiMessagePane(ActionListener disposalListener) {
	 ...
	 * @return This pane.
	 */
	public MiMessagePane setMessage(Object msg, int type) {
