...
public class MiSshClient
{
	...
	public void connectAndAuthenticate(SshAuthenticationClient authClient, String host) throws IOException
	{
		...
		m_SshClient.connect(host, new HostKeyVerification()
		{
		...
		MiSystem.logInfo(Category.MAINTENANCE, "Connecting to " + authClient.getUsername() + "@" + host);
	 ...
	 * @throws java.io.IOException
	 */
	public MiSshShell openShell(String encoding) throws IOException
	{
		return new MiSshShell(m_SshClient, encoding);
	}
}
