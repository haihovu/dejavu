...
public class MiSshAuthPromptGui implements SshAuthenticationPrompt
{
	...
	public MiSshAuthPromptGui(Frame parent, MiSshAuthInfo authRecord) throws AuthenticationProtocolException
	{
		super();
		m_Parent = parent;
	...
	public boolean showPrompt(SshAuthenticationClient authClient) throws AuthenticationProtocolException
	{
		synchronized(this)
		{
			...
			SwingUtilities.invokeLater(new Runnable()
			{
				...
				public void run()
				{
					MiGuiUtil.centerAndMakeVisible(new MiSshPasswdPrompt(m_Parent, m_AuthRecord.getUserName(), m_AuthRecord.getPassword(), new MiSshPasswdPrompt.PasswordListener()
					{
						@Override
						public void commit(String userName, String password)
						{
							synchronized(MiSshAuthPromptGui.this)
							{
								...
								m_PasswordSet = true;
								MiSshAuthPromptGui.this.notifyAll();
							}
						}
