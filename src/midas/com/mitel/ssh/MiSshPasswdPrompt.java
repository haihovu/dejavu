 ...
 * @author haiv
 */
public class MiSshPasswdPrompt extends javax.swing.JDialog
{
	 ...
	 */
	private class BgTaskCommit extends MiBackgroundTask
	{
	 ...
	 */
    public MiSshPasswdPrompt(java.awt.Frame parent, String existingUserName, String initialPassword, PasswordListener listener)
	{
        super(parent, true);
	...
	private static class SwingTaskSafeInstance implements Runnable
	{
		...
		private MiSshPasswdPrompt returnValue;
		/**
		...
		public void run()
		{
			synchronized(this)
			{
				returnValue = new MiSshPasswdPrompt(parentFrame, existingUserName, initialPassword, passwordLlistener);
				notify();
			}
		}
		 ...
		 */
		public MiSshPasswdPrompt getPromptDialog(long timeoutMs)
		{
			synchronized(this)
			{
				if(returnValue != null)
	 ...
	 */
	public static MiSshPasswdPrompt safeInstantiate(Frame parent, String existingUserName, String initialPassword, PasswordListener listener)
	{
    ...
    */
    public static void main(String args[])
	{
        java.awt.EventQueue.invokeLater(new Runnable()
		{
            ...
            public void run()
			{
                MiSshPasswdPrompt dialog = new MiSshPasswdPrompt(new javax.swing.JFrame(), "1234", null, new PasswordListener()
				{
					@Override
					public void commit(String userName, String password)
					{
						MiSystem.logInfo(Category.DESIGN, "user name = " + userName + ", password = " + password);
					}

					@Override
					public void cancelled()
					{
						MiSystem.logInfo(Category.DESIGN, "cancelled");
					}
				});
