...
/**
 * To be used with DjvTaskSupervised. This provides task monitoring/supervision functionality.
...
{
	private final Map<String, DjvTaskSupervised> taskRepository = new HashMap<String, DjvTaskSupervised>(128);
		...
		try
		{
			while(getRunFlag())
			{
				...
				synchronized(taskRepository)
				{
					...
					tasks = new ArrayList<DjvTaskSupervised>(taskRepository.values());
				}
