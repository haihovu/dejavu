 ...
 * as glass panes.
 */
public class DjvProgressPanel extends DjvFadingPane {
	 ...
	 */
	public DjvProgressPanel(Object msgs, ActionListener dismissListener) {
	 ...
	 * @return This panel
	 */
	public DjvProgressPanel setProgress(final int percent) {
	 ...
	 * @return This panel
	 */
	public DjvProgressPanel setProgress(final String text) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
